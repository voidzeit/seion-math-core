...
| PT-O-004 | Exact nonlinear cancellation-aware constants for associator, Jacobiator, Filippov, and general GJI | `OPEN` | P7B closes the finite source-polynomial inequality; universal sharp constants and P7C identities remain open |
